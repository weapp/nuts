...
class stemm_es {
	...
	function stemm($word) {
		if(array_key_exists($word, stemm_es::$excceptions)) return stemm_es::$excceptions[$word];
		$len = strlen($word);
...
stemm_es::$excceptions["cebollita"] = stemm_es::stemm("cebolla");
stemm_es::$excceptions["cebollitas"] = stemm_es::stemm("cebolla");
stemm_es::$excceptions["ajos"] = stemm_es::stemm("ajo");
stemm_es::$excceptions["pimientita"] = "pimmienta";
stemm_es::$excceptions["pimienta"] = "pimmienta";
stemm_es::$excceptions["pimientas"] = "pimmienta";
stemm_es::$excceptions["pimientos"] = "pimmiento";
stemm_es::$excceptions["pimiento"] = "pimmiento";
stemm_es::$excceptions["pimientito"] = "pimmiento";
stemm_es::$excceptions["pimientitos"] = "pimmiento";
?>